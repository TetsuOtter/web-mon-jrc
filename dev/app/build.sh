...
echo "================================"
echo "Building Tauri app (includes DMG to generate scripts)..."
echo "================================"

# Build app and dmg bundles to generate bundle_dmg.sh script
yarn run tauri build $ARGS --bundles app,dmg
