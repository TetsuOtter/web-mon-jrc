...
export const PAGE_TYPES = createMap([
	...
	"CONDUCTOR_INFO",
	"CONDUCTOR_SERVICE",
	"CONDUCTOR_AIR_COND_MODE",
	"CONDUCTOR_AIR_COND_VENT",
	"CONDUCTOR_AIR_COND_SUB",
	"CONDUCTOR_AIR_COND_FAN",
	"CONDUCTOR_315",

	"WORK_SETTING_TOP",
	"WORK_SETTING_TYPE",
	"WORK_SETTING_DESTINATION",
	"WORK_SETTING_TRAIN_NUMBER",
	"WORK_SETTING_SEAT",
...
export const PAGE_TO_GROUP = {
	...
	[PAGE_TYPES.BROKEN]: PAGE_GROUPS.DRIVER,

	[PAGE_TYPES.CONDUCTOR_INFO]: PAGE_GROUPS.CONDUCTOR,
	[PAGE_TYPES.CONDUCTOR_SERVICE]: PAGE_GROUPS.CONDUCTOR,
	[PAGE_TYPES.CONDUCTOR_AIR_COND_MODE]: PAGE_GROUPS.CONDUCTOR,
	[PAGE_TYPES.CONDUCTOR_AIR_COND_VENT]: PAGE_GROUPS.CONDUCTOR,
	[PAGE_TYPES.CONDUCTOR_AIR_COND_SUB]: PAGE_GROUPS.CONDUCTOR,
	[PAGE_TYPES.CONDUCTOR_AIR_COND_FAN]: PAGE_GROUPS.CONDUCTOR,
	...
	[PAGE_TYPES.WORK_SETTING_DESTINATION]: PAGE_GROUPS.WORK_SETTING,
	[PAGE_TYPES.WORK_SETTING_TRAIN_NUMBER]: PAGE_GROUPS.WORK_SETTING,
